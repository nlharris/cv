...
\begin{longtable}{p{0.5in}|p{5.5in}}
 ...
 2013 & A promoter level mammalian expression atlas. Submitted to Nature. Role: middle author \\
      ...
      & The GO Cell Component Ontology. Accepted by JBMS pending revisions. Role: middle author \\
      & The Cell Line Ontology (CLO). Submitted to JBMS. Role: middle author \\
...
\begin{tabular}{>{\everypar{\hangindent0.5in}}p{6in}}
	\textbf{Semantic LAMHDI} to develop a semantic infrastructure
        for linking human diseases to model systems. 2012-2016. Role: CoPI. \\
\end{tabular}
